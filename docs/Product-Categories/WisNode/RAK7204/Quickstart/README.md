...
<rk-img
  ...
  width="70%"
  caption="RAK7204 WisNode Sense Front View"
/>

### What do you need?
Before going through each and every step in the installation guide of the RAK7204 WisNode Sense, make sure to prepare the necessary items listed below:

1. **RAK7204 WisNode Sense**
2. Micro USB Cable
...
### Interfacing with the RAK7204 WisNode Sense

In order for you to be able to interface with the RAK7204 WisNode Sense with your Windows Machine, you need to download the RAK Serial Port Tool **[here](https://downloads.rakwireless.com/en/LoRa/Tools/RAK_SERIAL_PORT_TOOL_V1.2.1.zip).**
...
- Connect your RAK7204 WisNode Sense in your Windows Machine using the provided micro-usb cable.

<rk-img
  src="/assets/images/wisnode/rak7204/quickstart/3.interfacing/rak7204-pc.png"
  width="70%"
  caption="RAK7204 WisNode Sense to Laptop Connection"
/>
...
In this section, we will be connecting the RAK7204 WisNode Sense to The Things Network (TTN). If you don't have an account yet, head on to [https://www.thethingsnetwork.org/](https://www.thethingsnetwork.org/) and create one. Once done, Log in to your account and go to the console which can be found here:
...
1. **Device ID** - this is the unique identifier for your RAK7204 WisNode Sense in your application. You need to enter this manually.
...
Now, let us configure the RAK7204 WisNode Sense to work in OTAA mode in the EU868 band, as an example.

:::tip 📝 NOTE:
The default LoRa® working mode for the RAK7204 WisNode Sense is LoRaWAN® 1.0.2, while the default LoRa® join mode is OTAA, and the default LoRa® class is Class A.
:::
...
<rk-img
  ...
  width="100%"
  caption="Setting up the RAK7204 WisNode Sense operation mode"
/>
...
<rk-img
  ...
  width="100%"
  caption="Setting up the RAK7204 WisNode Sense OTAA parameters"
/>
...
<rk-img
  ...
  width="100%"
  caption="Sending Data to TTN from RAK7204 WisNode Sense"
/>
...
- As you can see in Figure 23, as we were in the same region (EU868), there was no change.
...
<rk-img
  ...
  width="100%"
  caption="Setting up the RAK7204 WisNode Sense ABP parameters"
/>
...
You can use RAK7204 WisNode Sense to connect with ChirpStack according to the following steps:
...
- The Device EUI which was set in the previous section to your RAK7204 WisNode Sense as "dev_eui" is the same in the image highlighted below.
...
:::tip 📝 NOTE:
The Application EUI which was into RAK7204 WisNode Sense as “app_eui” is not needed for ChirpStack.
:::
...
- Now, let us join our RAK7204 WisNode Sense using the OTAA activation mode.
...
- You can see the data which is just sent from RAK7204 WisNode Sense on ChirpStack page:
<rk-img
...
#### Analyzing Sensor Data from RAK7204 WisNode Sense
In the previous section, we have successfully sent some raw data from our RAK7204 WisNode Sense to The Things Network, but the problem is that you can't really see the actual sensor data from the payload. In this section , we will solve that and understand what each payload means.
...
The setup process for the RAK7204 WisNode Sense in LoRaP2P Mode is just the same with the process with the RAK811 Wisnode. These are the steps that you need to follow for this mode:

1. First, find two RAK7204 WisNode Sense which can work on EU868 frequency and make sure their firmware version isn’t less than V3.0.0.1.
...
Similarly, you can send message from RAK7204 WisNode Sense-1 to RAK7204 WisNode Sense-2 surely. Just try it freely. Great! We’ve done it, and that’s all about how to use
LoRaP2P on RAK811 WisNode.

You can use RAK7204 WisNode Sense LoRaP2P mode according to it.
...
### AT Commands for RAK7204 WisNode Sense

You can configure your RAK7204 WisNode Sense by sending AT Commands via a Serial port tool running on your PC. The following list shows the AT Commands that you can use:
...
:::tip 📝 NOTE:
 Usually you don't need to burn the bootloader since there is a bootloader already in RAK7204 WisNode Sense from V3.0.0.0 firmware and so on. If the firmware of your RAK7204 WisNode Sense is V3.0.0.0 or a newer one, **Skip this section.**
:::

You can burn the bootloader in your RAK7204 WisNode Sense by following the steps below:
...
3. Connect the RAK7204 WisNode Sense on your Windows PC's USB Interface and press the RST Button or power it on again.  Open the STM32CubeProgrammer Software and Select UART type.
...
5. Set the Baud Rate to 115200, and the Parity to Even as seen in Figure 73 then Press **Connect.**

- If you didn't properly set your RAK7204 WisNode Sense to work in BOOT Mode, you will see the following information in the Log Section of the Software:
...
- If this happens, Close the STM32CubeProgrammer and go back to the section above and set your RAK7204 WisNode Sense to work in **Boot Mode** again.
...
Now that you have successfully connected your RAK7204 WisNode Sense to the STM32CubeProgrammer Tool, let's burn the Bootloader into the RAK7204 WisNode Sense.

6. Download the Bootloader for the RAK7204 WisNode Sense **[here](https://downloads.rakwireless.com/en/LoRa/RAK7204/Firmware/)**.

7. In the STM32CubeProgrammer, Click the "Erase Chip" button to erase all the data on RAK7204 WisNode Sense:
...
10. After a couple of seconds, you will see the following window telling that you have successfully burned the Bootloader to your RAK7204 WisNode Sense!
<rk-img
...
:::warning ⚠️ WARNING
 Disconnect your RAK7204 WisNode Sense in your Windows PC and do not forget to remove the Jumper on the Boot Line Pins to work in Normal Mode.
:::

### Burning the Firmware

If the firmware version of your **RAK7204 WisNode Sense**  is newer than V3.0.0.0 or you have just burned the bootloader into the board according to the **Burning the Bootloader** section, follow the steps below

- Make sure you have set your RAK7204 WisNode Sense to work in boot mode. If you have just burned the bootloader according to the previous section, it works in boot mode now. 
...
- Download the latest firmware [here](https://downloads.rakwireless.com/en/LoRa/RAK7204/Firmware/) for the RAK7204 WisNode Sense
...
- Choose the correct "**COM Port**", then click Start to Upgrade and wait for a couple of minutes. If it won't start, push the reset button on your RAK7204 WisNode Sense.
...
In order for you to check if you have successfully installed the firmware on your RAK7204 WisNode Sense, open the Serial Port tool again. Press the "Reset button" or type the command below. If everything works  perfectly, you should see the following message below:
